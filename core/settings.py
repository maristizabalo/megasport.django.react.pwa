...
DATABASES = {
    'default': env.db("DATABASE_URL", default="postgres:///megasport")
}
...
REST_FRAMEWORK = {
    # Permisos de quien puede interactuar con nuestra API
...
#Podamos hacer login correctamente
